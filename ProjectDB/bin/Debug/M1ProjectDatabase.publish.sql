...
END
GO
IF NOT EXISTS (SELECT OperationKey FROM [dbo].[__RefactorLog] WHERE OperationKey = '80adbe44-f26d-4885-84b0-a50d88e6bd0b')
INSERT INTO [dbo].[__RefactorLog] (OperationKey) values ('80adbe44-f26d-4885-84b0-a50d88e6bd0b')
